  ...
  return (
    <div className="mx-auto max-w-4xl px-5">
      ...
      <section className="border-b-2 border-ink pb-10 pt-12 md:pt-16">
        <p className="eyebrow text-[11px] text-accent">{t("eyebrow")}</p>
      ...
      <section className="mt-12">
        <div className="mb-6 flex items-center gap-4">
          <h2 className="font-serif text-2xl font-black">{t("bioTitle")}</h2>
      ...
      <section className="mt-16">
        <div className="mb-6 flex items-center gap-4">
          <h2 className="font-serif text-2xl font-black">{t("skillsTitle")}</h2>
          <span className="pt-1 font-mono text-[10px] tracking-[.25em] text-inksoft">
            SKILLS
          </span>
          <div className="h-px flex-1 bg-line" />
      ...
      <section className="mb-20 mt-16">
        <div className="mb-6 flex items-center gap-4">
          <h2 className="font-serif text-2xl font-black">{t("contactTitle")}</h2>
          <span className="pt-1 font-mono text-[10px] tracking-[.25em] text-inksoft">
            CONTACT
          </span>
          <div className="h-px flex-1 bg-line" />
        ...
        <ul className="grid gap-4 sm:grid-cols-3">
          ...
          <li>
            <div className="card-raise block border border-line bg-card p-5 text-center transition-colors hover:border-ink">
              <p className="font-serif text-lg font-black">{t("wechat")}</p>
