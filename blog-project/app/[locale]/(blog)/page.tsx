...
export default async function Home({
  ...
  const HERO_KEYWORDS = t.raw("hero.keywords") as string[];
    ...
    <div>
      ...
      <section id="articles" className="mx-auto mt-16 max-w-6xl px-5">
        <div className="mb-2 flex items-center gap-4">
          <h2 className="font-serif text-2xl font-black">{t("recent.title")}</h2>
                ...
                >
                  ...
                  <div className="flex flex-col justify-center gap-3 p-6 md:p-8">
                    <p className="font-mono text-[10px] tracking-[.15em] text-inksoft">
                      {formatDate(featured.createdAt)} · {featured.readingMinutes} MIN ·{" "}
                      {common("units.viewsCount", { views: featured.views })}
                    </p>
      ...
      <section id="projects" className="mx-auto mt-20 max-w-6xl px-5">
        <div className="mb-2 flex items-center gap-4">
          <span className="eyebrow text-[11px] text-accent">{t("projects.eyebrow")}</span>
        ...
        <h2 className="mt-3 font-serif text-2xl font-black">{t("projects.title")}</h2>
